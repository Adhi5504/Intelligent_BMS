...
echo ======================================================================
echo Select the Fault Dataset you want to stream:
echo   [1] Overvoltage Fault
echo   [2] Undervoltage Fault
echo   [3] Overcurrent Fault
echo   [4] Overtemperature Fault
echo   [5] Cell Imbalance Fault
echo   [6] Weak Cell Fault
echo ======================================================================
set /p DATASET_CHOICE="Enter choice [1-6]: "

set "DATASET_FILE=BMS_Fault_Overvoltage.xlsx"
if "%DATASET_CHOICE%"=="2" set "DATASET_FILE=BMS_Fault_Undervoltage.xlsx"
if "%DATASET_CHOICE%"=="3" set "DATASET_FILE=BMS_Fault_Overcurrent.xlsx"
if "%DATASET_CHOICE%"=="4" set "DATASET_FILE=BMS_Fault_Overtemperature.xlsx"
if "%DATASET_CHOICE%"=="5" set "DATASET_FILE=BMS_Fault_Cell_Imbalance.xlsx"
if "%DATASET_CHOICE%"=="6" set "DATASET_FILE=BMS_Fault_Weak_Cell.xlsx"

echo [*] Starting VNet / Bluetooth Gateway in MOCK Mode with %DATASET_FILE%...
start "VNet Bluetooth Gateway" /D "%~dp0..\backend" python bms_bluetooth_gateway.py --bms MOCK --dataset "..\data\!DATASET_FILE!"
